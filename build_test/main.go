...
func main() {
	...
	data.Sections = append(data.Sections, timedCollect("GetContainers(layer size)", func() (any, error) {
		withLayers := syStats
		withLayers.ContainerLayerSize = true
		return withLayers.GetContainers(systats.Megabyte)
	}))
